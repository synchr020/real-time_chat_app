...
const googleAuth = require('./googleAt/google');
...
passport.use(
  new GoogleStrategy(
   ...
   // callbackURL:  "https://rtchatapp.onrender.com/auth/google/callback"
    },
...
router.get(
  ...
  (req, res) => {
    res.redirect('/auth/google/chat'); // Successful authentication, redirect success.
  }
);
...
router.get('/chat', async (req, res) => {
  ...
  const userProfile1 = req.user;
  res.render('app', { user1: userProfile1 });
